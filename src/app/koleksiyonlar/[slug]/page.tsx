...
const collections: Record<string, CollectionConfig> = {
  "sinirli-uretim": {
    ...
    image: "https://images.unsplash.com/photo-1617019114583-affb34d1b3cd?w=1920&h=600&fit=crop",
    isLimited: true,
  },
  jersey: {
    ...
    image: "https://images.unsplash.com/photo-1590080876351-941da357a4e4?w=1920&h=600&fit=crop",
    category: "jersey",
  },
  sifon: {
    ...
    image: "https://images.unsplash.com/photo-1594938328870-9623159c8c99?w=1920&h=600&fit=crop",
    category: "sifon",
  },
  dokuma: {
    ...
    image: "https://images.unsplash.com/photo-1613844237701-8f3664fc2eff?w=1920&h=600&fit=crop",
    category: "dokuma",
  },
  saten: {
    ...
    image: "https://images.unsplash.com/photo-1606567595334-d39972c85dbe?w=1920&h=600&fit=crop",
    category: "saten",
  },
  spor: {
    ...
    image: "https://images.unsplash.com/photo-1585842378054-ee2e52f94ba2?w=1920&h=600&fit=crop",
    category: "spor",
  },
};
